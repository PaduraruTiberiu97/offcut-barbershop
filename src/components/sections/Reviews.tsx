...
const reviews = [
  {
    name: "Andrei P.",
    role: "Client din 2019",
    text: "Denis nu doar tunde — îți citește fața, stilul, dispoziția. Cel mai curat fade pe care l-am avut vreodată.",
    color: "bg-primary text-primary-foreground",
  },
  {
    name: "Vlad M.",
    role: "Prima vizită",
    text: "Am intrat sceptic, am ieșit cu următoarele patru programări făcute. Rasul cu prosop cald e altă treabă.",
    color: "bg-secondary",
  },
  {
    name: "Cristi R.",
    role: "Cavaler de onoare",
    text: "Mi-a tuns toți băieții în dimineața nunții. Calm, profi, ne-a terminat la fix. Respect.",
    color: "bg-accent",
  },
  {
    name: "Mihai L.",
  ...
  },
  {
    name: "Tudor I.",
    role: "Băiat cu barbă",
    text: "Barba mea n-a arătat niciodată mai bine. A conturat-o exact cum trebuie. Game changer.",
    color: "bg-[hsl(var(--pop-purple))] text-primary-foreground",
  },
];
      ...
      <div className="container relative">
        <Reveal>
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <h2 className="font-display text-5xl lg:text-7xl uppercase mb-6 leading-[0.9]">
              Ce zic
              <br />
              <span className="text-primary text-shadow-pop">băieții.</span>
            </h2>
        ...
        <Reveal>
          <div className="relative max-w-3xl mx-auto">
            <div
              className={`relative ${current.color} ink-outline rounded-3xl shadow-pop-lg p-10 lg:p-14 transition-colors duration-500`}
            >
              ...
              <div className="text-center min-h-[220px] flex flex-col justify-center">
                <p className="font-display text-2xl lg:text-3xl leading-snug uppercase mb-8">"{current.text}"</p>
