...
export const Hero = ({ bookingUrl }: { bookingUrl: string }) => {
  return (
    <section id="top" className="relative min-h-screen overflow-hidden pt-28 bg-halftone flex flex-col">
      ...
      <div className="container relative z-10 grid lg:grid-cols-12 gap-10 items-center flex-1 pb-16">
        <div className="lg:col-span-7 space-y-8">
          ...
          <p className="font-condensed text-xl tracking-wide text-foreground max-w-xl">
            ...
            Denis la Offcut — barberul tău din cartier.
          </p>
      ...
      {/* Marquee strip */}
      <div className="mt-16 bg-foreground text-background py-6 overflow-hidden border-y-[3px] border-foreground flex items-center">
          ...
          {Array(10)
            ...
            .map((_, i) => (
              <span key={i} className="flex items-center gap-12">
                ...
                Luni – Vin | 09:00 – 19:30 <span className="text-secondary">✦</span>
                Sâmbătă | 09:00 – 15:00 <span className="text-accent">✦</span>
                Duminică | 09:00 – 13:00 <span className="text-[hsl(var(--pop-yellow))]">✦</span>
              </span>
            ))}
        </div>
      </div>
